...
import { metaCfg, waCfg, linkedinCfg, threadsCfg, telegramCfg, blueskyCfg, mastodonCfg } from "../lib/social.mjs";
...
export default async (req) => {
  ...
  const meta = metaCfg(), wa = waCfg(), li = linkedinCfg(), th = threadsCfg(), tg = telegramCfg(), bs = blueskyCfg(), ma = mastodonCfg();
  const connections = [
