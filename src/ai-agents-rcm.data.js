...
export const AI_AGENTS_FAQ = [
  ...
  { q: "Which RCM tasks can AI agents automate?", a: "Eligibility and benefits verification, prior authorization, medical coding and charge capture, claims submission and follow-up, denial management, payment posting and patient collections - the connected stages from the first appointment to the final payment." },
