...
export const en = {
  ...
  hero: {
    ...
    s4_eyebrow: "Product · MedXFlow RCM Billing",
    s4_h2a: "Claims out clean.",
    s4_h2b: "Cash in faster.",
    s4_lead:
      "MedXFlow runs the back-office billing cycle end to end - claims scrubbed and submitted, payments posted, denials worked and patients billed - so more of every dollar lands in your account.",
    s4_cta1: "See the billing suite",
    s4_cta2: "Book a demo",
    s4_note: "Clean claims · Denials worked · Faster payments",
  ...
  about: {
    ...
    h2b: "billing cycle management.",
    body: "MedXFlow is built by a team with deep, hands-on experience running revenue cycle and medical billing for US practices - from eligibility and prior authorization to charge capture, claims, denials and patient collections. We've worked the worklists, fought the denials and closed the month, so we know exactly where revenue leaks and how AI plugs it.",
    exp1_h: "Decades in the revenue cycle",
    exp1_d: "Years spent running billing, collections and A/R across multi-site practices and billing companies - not just advising on it.",
    exp2_h: "Every stage, hands-on",
    exp2_d: "From eligibility and prior auth to charge capture, claims submission, denial management and patient collections - we've done the work end to end.",
    exp3_h: "Built for real workflows",
    exp3_d: "Designed by people who've worked the worklists and closed the month, so MedXFlow fits how billing teams actually operate.",
  },

  faq: {
    eyebrow: "FAQ",
    h2: "Questions, answered.",
    q1: "What does MedXFlow do?",
    a1: "MedXFlow runs your entire revenue cycle with AI agents - scheduling, eligibility, prior authorization, coding, claims, payment posting, denial management and patient collections - plus a 24/7 AI front desk (voice, chat and check-in) and telehealth. One connected platform, from the first appointment to the final payment.",
    q2: "Is patient data secure and HIPAA compliant?",
    ...
    q3: "Which EHRs and clearinghouses does it work with?",
    a3: "MedXFlow writes bookings, arrivals, charges and payments straight into the systems you already run - Epic, athenahealth, eClinicalWorks and more - and submits claims to every major payer and clearinghouse. No rip-and-replace, with a fallback mode that works even before formal integration.",
    q4: "Do the AI agents replace our billing team?",
    a4: "Only the repetitive work. The agents handle the volume and hand anything they're unsure about to your staff - AI backed by humans, never left unattended. Prefer to hand it all over? Our human-led Managed Billing team can run the whole cycle for you. Either way, every action is tracked, assigned and auditable.",
    q5: "How long does setup take?",
    a5: "Most practices are live within a week. We connect your EHR (Epic, athenahealth and more), configure your workflows and payer rules, and run a supervised pilot before MedXFlow goes live on real work.",
    q6: "What are the contract terms?",
    a6: "Practices get a 30-day trial and free setup, with no long lock-in - cancel with 30 days' notice.",
  },
