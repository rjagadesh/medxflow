...
export const TERMS = [
  ...
  { slug: "patient-responsibility", term: "Patient Responsibility", def: "The portion of a bill the patient owes - copays, deductibles and coinsurance - after insurance pays its share.",
    body: [
      "Patient responsibility is what remains on a claim after the payer adjudicates it and applies the contractual adjustment. It is the sum of any copay, deductible and coinsurance the plan assigns, plus any non-covered or out-of-network charges the patient has agreed to pay. It appears on the payer's explanation of benefits (EOB) as the patient-responsibility or amount-you-owe line, and it becomes the statement your practice sends to the patient.",
      "This balance has grown into one of the largest and hardest-to-collect parts of practice revenue. The spread of high-deductible health plans has shifted more of every dollar of care onto patients, and unlike a payer, a patient has no contract obligating prompt payment. Balances that leave the building unpaid are collected at a small fraction of the rate of amounts collected at or before the visit, so patient responsibility is where a lot of earned revenue quietly leaks away.",
      "The most reliable way to collect it is to move the conversation earlier in the visit. Verify eligibility and read the plan's copay, deductible and coinsurance before the patient arrives, generate an accurate out-of-pocket estimate, and collect at the point of service or keep a card on file for the balance after the claim adjudicates. Clear, itemized statements and simple digital payment options recover most of the rest.",
      "Getting patient responsibility right also protects the front end of the revenue cycle. An estimate that is wrong in either direction erodes trust and slows payment, and a missed eligibility check can turn what should have been a clean patient balance into a denied claim that has to be reworked.",
      "One distinction worth keeping straight: patient responsibility is the total a patient owes, while copay, deductible and coinsurance are the individual cost-sharing mechanisms that add up to it. See those terms for how each one is calculated.",
    ],
